...
$sql = "SELECT questions.qst_id , questions.qst_content , 
...
<div id="wrapper">
  ...
  <tbody>
            ...
            while ($row = mysqli_fetch_array($result)) : ?>
                ...
                ?>
                <tr>
                    <td><?php echo $num_qst; ?></td>
                    <td><?php echo $row["qst_content"]; ?></td>
                    <td><?php echo $rep_std; ?></td>
                    <td><?php echo $rep_tr; ?></td>
                    <td style = "text-align : center;"><?php echo $result_std ?></td>
                    <td scope="col"><?php echo $rep_ratt ?></td> 
                    <td scope="col" style = "text-align : center;"><?php echo $result_ratt ?></td> 
                </tr>
            <?php endwhile; ?>
            <tr>
                <td> </td>
