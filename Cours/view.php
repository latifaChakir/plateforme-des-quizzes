    ...
    <div class="container mt-5">
        <form id="coursForm" method="post">
            <div class="form-group">
                <label>Nom</label>
                <input type="text" class="form-control" name="cours_name" value="<?php echo isset($row["cours_name"]) ? $row["cours_name"] : ''; ?>"
                    required>
            </div>
            <div class="form-group">
                <label>Lien vers le cours</label>
                <input type="text" class="form-control" name="url"  value="<?php echo isset($row["cours_content"]) ? $row["cours_content"] : ''; ?>" required>
            </div>
            <div class="form-group">
