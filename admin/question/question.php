...
<?php  
    ...
    echo "<a href='addquestion.php?cour_id=$cour_id'><input type='submit' value='Ajouter'></a>";
?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="tdTable1">
        ...
        <a href="question.php?id=<?php echo $cour_id; ?>&qst_id_delete=<?php echo $row['qst_id']; ?>" style="text-decoration: none; color: red; padding: 0px 5px;">Supprimer</a>
      </td>      
