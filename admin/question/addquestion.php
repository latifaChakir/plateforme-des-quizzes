	...
	<div id="wrapper">
		...
		<section id="content">
			...
			?>
					...
					<input type="submit" value="Ajouter Et Retour a liste des cours" name="sub2">

					<a href="question.php?id=<?php echo $cour_id?>" id="Retour">retour a la liste des question</a>
